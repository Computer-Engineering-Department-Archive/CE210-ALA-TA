...
\item
اگه از توابع درست استفاده کنین (که به صورت \textbf{Bold} شد مشخص شده اند)، هر بخش یک و یا نهایت دو خط کد میشه!
\item
...
\begin{latin}
9531000\_Bastian\_Schweinsteiger\_MatlabIntro.m
\end{latin}
\item \color{red}

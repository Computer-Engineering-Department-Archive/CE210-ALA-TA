...
\begin{itemize}
\item
ضمن تبریک عید باستانی نوروز به دانشجویان گرامی و آرزوی سالی خوش ،خرم و همراه با موفقیت برای عزیزان ،سری اول تمرینات با موضوع معادلات خطی در جبر خطی تقدیم شما می شود.
\item
این سری تمرین شامل 12 سوال نظری  است که سوالات شبیه سازی نیز به زودی در اختیار شما قرار خواهد گرفت.
...
\lr{\[9531000\_T\_Sokratis\ \ Papastathopoulos\_HW1.pdf\]}
\\
و تمرینات عملی و شبیه سازی را به شکل:\\
\lr{\[9531000\_S\_Sokratis\ \ Papastathopoulos\_HW1.pdf\]}
ارسال فرمایید.
\item
\color{red}
مهلت تحویل تمارین ساعت 11:55 روز جمعه 97/1/24 خواهد بود.
\end{itemize}
{\bf تمارین:}
\\
\\

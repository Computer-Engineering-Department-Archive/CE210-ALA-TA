...
\begin{itemize}
\item
سری سوم تمرینات با موضوع فضای برداری را در زیر مشاهده می کنید. 
\item
این سری تمرین شامل 9 سوال اجباری  و 2 سوال امتیازی است که نمره سوالات امتیازی به نمره تمارین شما اضافه خواهد شد.


\item 
پس از حل مسائل آن ها را به صورت یک فایل 
\lr{pdf}
 در قسمت مورد نظر با فرمت زیر 
\\
\lr{\[9531000\_T\_Claude\ \  Makelele\_HW3.pdf\]}

آپلود کنید.
\item
\color{red}
مهلت ارسال پاسخ تمارین ساعت 23:55 روز دوشنبه 97/3/21 خواهد بود.
\end{itemize}
{\bf تمارین:}
\\
\\

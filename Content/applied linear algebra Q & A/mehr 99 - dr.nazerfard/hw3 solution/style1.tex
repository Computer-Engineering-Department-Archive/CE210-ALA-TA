...
\\
\begin{itemize}
پاسخ سوالات را به دقت از سولوشن که بر روی کانال قرار گرفته است بیابید و به طور کامل مطالعه کنید،برخی سوالات دارای پاسخ بدیهی بودند که صرفا برای تمرین بیشتر در نظر گرفته شده بودند که از آوردن حل آن ها خودداری کردیم.
\end{itemize}
{\bf تمارین:}
\\
\\

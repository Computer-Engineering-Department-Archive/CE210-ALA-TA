...
\begin{itemize}
\item
این تمرین از مباحث مربوط به فصل5 ،6و7 طراحی شده است که شامل 11سوال اجباری و 8 سوال امتیازی است که نمره سوال های امتیازی فقط به نمرات تمرین شما کمک می کند.
\item 
...
\\
\lr{\[9531000\_T\_Lutz\ \ Pfannenstiel\_HW4.pdf\]}

آپلود کنید.
\item
\color{red}
مهلت ارسال پاسخ تمارین ساعت 23:55 روز جمعه 97/4/1 خواهد بود.
\end{itemize}

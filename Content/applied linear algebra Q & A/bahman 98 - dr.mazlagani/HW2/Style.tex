...
\settextfont[Scale=1.1]{XB_Niloofar.ttf}
\setdigitfont[Scale=1.1]{XB_Niloofar.ttf}
\defpersianfont\sayeh[Scale=1.1]{XB_Niloofar.ttf}
...
\begin{itemize}
\item
این تمرین از مباحث مربوط به فصل دوم (جبر ماترسی) طراحی شده است که شامل ۴ مساله و یک تمرین شبیه سازی می باشد.

\item 
کلاس تدریسیار هفته بعد از موعد تحویل مربوط به رفع مشکلات این تمرین است. تا زمان کلاس سوالات خود را از طریق ایمیل زیر بپرسید.
\begin{latin}
\href{mailto:aut.la2018@gmail.com}{\[aut.la2018@gmail.com\]}
\end{latin}
\item
مساله ها را در یک فایل pdf و فایل کد های مربوط به تمرین های شبیه سازی و گزارش های آنها را به طور مجزا در یک پوشه قرار دهید.

\item پاسخ های تمرین را در قالب یک فایل به صورت الگوی زیر آپلود کنید.
\begin{latin}
9531000\_Gabriel\_Batistuta\_HW2.zip
\end{latin}
\item \color{red}
مهلت تحویل جمعه 25 اسفند 1396 ساعت 23:54
\end{itemize}

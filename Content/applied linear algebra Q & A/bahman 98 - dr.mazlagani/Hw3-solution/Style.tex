...
\begin{itemize}
\item
دانشحویان گرامی پاسخ های سوالات را به دقت بخوانید و پاسخ های خود مقایسه کنید تا در صورتی که سوالی را نتوانسته اید حل کنید یا غلط حل کرده اید متوجه آن شوید.

\item 
روز شنبه 5 اردیبهست ماه  در کلاس درس کوییزی از این سوالات خواهید داشت.

...
\begin{itemize}
\item
دانشجویان گرامی پاسخ های سوالات را به دقت بخوانید و با پاسخ های خود مقایسه کنید تا در صورتی که سوالی را نتوانسته اید حل کنید یا غلط حل کرده اید متوجه آن شوید.

\item
روز یکشنبه 96/12/13کلاس حل تمرین با موضوع بررسی مسائل تمرین اول ساعت 12:30 تا 13:15 در کلاس 01 تشکیل خواهد شد.
\item \color{red}
روز دوشنبه 96/12/14 در کلاس درس کوییزی از این تمرینات توسط دکتر مزلقانی برگزار خواهد شد پس با آمادگی کامل در این کوییز حضور یابید.
\end{itemize}

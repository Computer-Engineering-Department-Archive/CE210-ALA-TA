...
\begin{itemize}
\item
این تمرین از مباحث مربوط به فصل اول (معادلات خطی در جبر خطی) طراحی شده است که شامل ۶ مساله و دو تمرین شبیه سازی می باشد.

\item 
کلاس تدریسیار هفته آینده مربوط به رفع مشکلات این تمرین هست. ولی تا اون موقع اگه سوال داشتین از طریق
\begin{latin}
...
\begin{latin}
9531000\_Gabriel\_Batistuta\_HW1.zip
\end{latin}
\item \color{red}
مهلت تحویل جمعه ۱۱ اسفند 1396 ساعت 23:54
\end{itemize}

...
\vspace{-.2em}
{\scriptsize\bf دانشکده مهندسی کامپیوتر و فناوری اطلاعات}
\hfill {\small
مدرس: دکتر امیر مزلقانی  \ 
}\\[-5em]
\centerline{\hfill\Large\bf 
جبر خطی کاربردی 
}\\[.7em]
\centerline{\hfill\bf 
نیم‌سال دوم ۹۶-۹۷
...
\begin{itemize}
\item first
این تمرین صرفا جهت آشنایی و انتخاب ابزار شبیه سازی مورد نظر شما هستش و نمره ای نداره!! ولی انجامش به شدت توصیه میشه چون هم با یک سری دستورات پایه ای مورد نیازتون آشنا می شید و هم مشکلات نصب و راه اندازی را همین اول ترم که سرتون خلوت تره حل می کنین!

\item
درسته که این تمرین نمره نداره ولی ددلاین که داره!! ددلاینش هم تا جمعه شب و قبل از آپلود اولین تمرینتون هست. سعی کنین انجامش بدید که بعدا به مشکل نخورین.
\item 
کلاس تدریسیار هفته آینده به رفع مشکلات احتمالی که در این مسیر پیش میاد هست. ولی تا اون موقع اگه سوال داشتین از طریق
\begin{latin}
...
\begin{latin}
9531000\_Bastian\_Schweinsteiger\_HW1-CA.pdf
\end{latin}
\item \color{red}
مهلت تحویل جمعه 27 بهمن 1396 ساعت 23:54:59.99
\end{itemize}
